...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<pair<unsigned int,double> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<pair<unsigned int,double> >", -2, "vector", 339,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("deque<double>", -2, "deque", 832,
...
"external",
"/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.22.06-1d426/x86_64-centos7-gcc8-opt/include/",
"/afs/cern.ch/work/s/schhibra/pythia8244_with_sueps/Delphes-3.5.0/",
0
    };
