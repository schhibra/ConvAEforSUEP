...
Suep_shower::Suep_shower(double mass, double temperature, Pythia8::Rndm *rndm) {
  ...
  p_plus = (bisect(boost::bind(&Suep_shower::test_fun, this, boost::placeholders::_1),pmax,50.0, tol)).first; // first root
  p_minus = (bisect(boost::bind(&Suep_shower::test_fun, this, boost::placeholders::_1), 0.0,pmax, tol)).first; // second root
...
vector< Vec4 > Suep_shower::generate_shower(double energy){
  ...
  p_scale = (bisect(boost::bind(&Suep_shower::reballance_func, this, boost::placeholders::_1, event),0.0,2.0, tol)).first;
